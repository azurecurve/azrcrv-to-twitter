 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_tt')){
	function azrcrv_create_plugin_menu_tt(){
		azrcrv_create_plugin_menu_table_tt();
		azrcrv_populate_plugin_menu_table_tt();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_tt')){
	function azrcrv_populate_plugin_menu_table_tt(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_tt')){
	function azrcrv_create_plugin_menu_table_tt(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
